#include <cassert>
#include <framework/utils/base/logging.h>
#include <framework/app_template/app_manager.h>
...
bool AppManager::init(const std::shared_ptr<VkConfig> &config, VkFormat color_format, VkFormat ds_format) {
...
void AppManager::setApp(std::shared_ptr<AppBase> &&app) {
  app_ = std::move(app);
