...
namespace vk_engine
{
    ...
    // dynamic pipeline state vulkan 1.0: viewport, scissor, line width, depth bias, blend constants...
    // 1.3: depth test enable, depth write enable, depth compare op, depth bounds test enable...
