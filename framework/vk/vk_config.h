...
public:
  ...
  enum class FeatureExtension : uint32_t {
    ...
    KHR_GET_MEMORY_REQUIREMENTS_2 = 11,
    KHR_DEDICATED_ALLOCATION = 12,
    KHR_BUFFER_DEVICE_ADDRESS = 13,
    KHR_DEVICE_GROUP = 14,
    DEVICE_EXTENSION_END_PIVOT = 15,
  ...
  const char *const kFeatureExtensionNames[static_cast<uint32_t>(
      ...
      VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME, // 11 
      VK_KHR_DEDICATED_ALLOCATION_EXTENSION_NAME, // 12
      VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME, // 13
      VK_KHR_DEVICE_GROUP_EXTENSION_NAME, // 14
      "DEVICE_EXTENSION_END_PIVOT", // 15
  };
