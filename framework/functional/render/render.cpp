#include <cassert>
#include <framework/functional/render/render.h>
...
void Render::render(Scene *scene, Gui * gui)
{
  ...
  global_param_set->setCameraParam(cam.getCameraPos(), cam.ev100(), cam.getViewMatrix() /* cam_tr->gtransform */, cam.getProjMatrix());
