...
mkdir -p install/include/contrib
Copy-Item -path 'thirdparty\assimp\contrib\utf8cpp' -Destination 'install\include\contrib' -Recurse

@REM git clone https://github.com/vblanco20-1/decs.git thirdparty/decs
